    ...
    public function index() {
       ...
       // $this->data["session_list"] = $this->action->read_distinct("registration",array(),"session");
        ...
        if ($this->input->post('show_students')) {
          ...
          $this->data['all_students']=$this->action->readOrderby('admission','roll',$where,'ASC');
        }

        // student attendance submit start
        if($this->input->post('submit')){
            
            //print_r($_POST['reg_id']);
                   ...
                   $this->data['confirmation']=message('warning',$msg_array);
                    ...
                    $this->data['confirmation']=message($this->action->add('attendance',$data),$msg_array);
                     ...
                     foreach($guardian_mobile as $key => $num) {
                        ...
                        $studentInfo = $this->action->read('registration', array('guardian_mobile' => $num));
                        ...
                        $content= "Dear Guardian, Your ". $gender ." ". $student ." is absent today, Regards Principal, BGPSC, Sylhet";
     ...
     public function student_report() {
        ...
        if ($this->input->post('submit')){
          ...
          $cond=array('roll'=>$this->data['roll']);                    

          $this->data['students_report']=$this->action->read("attendance",$where);
