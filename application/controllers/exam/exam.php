...
class Exam extends Admin_Controller {
        ...
        if(isset($_POST["set"])){
            ...
            foreach($this->input->post("name") as $key => $val){
                $data = array(
                    ...
                    "assignment"                        => $_POST["assignment"][$key],
                    "assignment_pm"                     => $_POST["assignment_pm"][$key],
                    "cleanliness"                       => $_POST["cleanliness"][$key],
                    "cleanliness_pm"                    => $_POST["cleanliness_pm"][$key],
    ...
    public function allExam() {
        ...
        $this->data["result"] = get_result("exam", [], [], 'class', 'class', 'ASC');

        if(isset($_POST["show"])){
            $where = array("exam_id" => $this->input->post("exam"));
            $this->data["result"] = get_result("exam", $where, [], 'class', 'class', 'ASC');
	...
	public function details() {
        ...
        $this->data["info"] = get_result("exam", ["class" => $_GET['class'],"exam_id" => $this->input->get("q")], [], '', 'subject', 'ASC');
