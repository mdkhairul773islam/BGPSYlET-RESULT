...
ul.new_bottom_social{margin-left: 62px;}
...
<div class="footer-wrapper">
    <div class="container">
        <div class="row new_footer">
            <div class="new_div111" style="background:#161616;width:100%;height:100px;">
                <div class="col-md-4">
                    <table>
                        <tr>
                            <td><i class="fa fa-map-marker fa-3x"></i> 
                            <span style="width:1px;height:35px;background:#780202;position:absolute;top:40px;left:60px;"></span></td>
                            <td style="padding-left:25px;"><b>Visit Us</b> <br>Notre Dame College, P.O Box- 36 <br>Barera, Mymensingh-2200</td>
                        </tr>
                    </table>
                ...
                <div class="col-md-4">
                    <table>
                        <tr>
                            <td><i class="fa fa-envelope-o fa-3x"></i>
                            <span style="width:1px;height:35px;background:#780202;position:absolute;top:40px;left:80px;"></span></td>
                            <td style="padding-left:25px;"><b>Email Us</b> <br>contact@ndcm.edu.bd<br>info@ndc.edu.bd</td>
                        </tr>
                    </table>
                    <div style="width:1px;height:50px;background:rgba(255,255,255,0.1);position:absolute;top:25px;right:0;"></div>   
                </div>
                <div class="col-md-4">
                    <table>
                        <tr>
                            ...
                            <span style="width:1px;height:35px;background:#780202;position:absolute;top:40px;left:60px;"></span></td>
                            <td style="padding-left:25px;"><b>Call Us</b> <br>+88 01552-342131<br>+88 01987-009100</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row new_footer">
            <div style="width:100%;" class="new_footer_bottom">
                <div class="col-md-4">
                    <img src="<?php echo site_url('public/logo/logo.png');?>" />
                </div>
                <div class="col-md-4">
                    <table>
                        <tr>
                            <td colspan="2"><b style="padding-bottom:10px;display:block;">Navigation</b></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><a href="<?php echo site_url('online/regInfo/information'); ?>">Admission Rules</a></td>
                            <td><a href="<?php echo site_url('online/regInfo'); ?>">Online Registration</a></td>
                        </tr>
                        <tr>
...
<div class="footer-wrapper-bottom">
    ...
    <div class="col-md-12 new_footer_bottom2">
        <div class="row">
            <div class="col-md-4 new_footer_bottom2">
                <p>&copy;  Notre Dame College, Mymensingh.</p>  
                <i style="height:30px;width:100%;display:block;"></i> 
            </div>
            <div class="col-md-4 new_footer_bottom2">
                <ul class="new_bottom_social" style="padding-top: 18px; list-style-type: none;">
                    <li><a href="#" class="fb"><i class="fa fa-facebook"></i></a></li>
                    <li><a href="#" class="tw"><i class="fa fa-twitter"></i></a></li>
                    <li><a href="#" class="yo"><i class="fa fa-youtube"></i></a></li>
                    <li><a href="#" class="fl"><i class="fa fa-flickr"></i></a></li>
                </ul>
            </div> 
            <div class="col-md-4 new_footer_bottom2 new_footer_bottom3">
                <p><span>
...
<script src="http://maps.googleapis.com/maps/api/js"></script>
 <script type="text/javascript" src="<?php echo site_url('public/js/google-map-dark.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url('public/js/jasny-bootstrap.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url('public/js/jquery-1.12.4.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo site_url('public/js/lightbox.js'); ?>"></script>
