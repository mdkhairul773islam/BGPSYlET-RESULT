...
<div class="container-fluid block-hide">
    ...
    echo form_open('stock_reg/stock/add', $attribute);
    ?>

        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title pull-left">
                    <h1>Field of Stock Regsister</h1>
                </div>
            </div>
            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">                                
                    ...
                    <div class="form-group">
                        <label for="" class="col-md-3 control-label">Field of Stock  </label>
                        <div class="col-md-7">
                            <input name="field_stock" class="form-control" >
                        </div>
                    </div>
...
<div class="container-fluid" >
    <div class="row" ng-controller="stockRegCtrl">
        <div class="panel panel-default">
            <div class="panel-heading none">
                <div class="panal-header-title pull-left">
                    <h1>All Field of Stock Regsister</h1>
                </div>
            ...
            <table class="table table-bordered" ng-cloak>
                <tr>
                    ...
                    <th>Field of Stock Regsister </th>
                ...
                <tr dir-paginate="row in fields|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
                    <td class="num-center">{{row.sl}}</td>
                    <td>{{row.stock_field}}</td>
                    <td class="none text-center" >                        
                        <?php //if(ck_action('stock_reg_menu', 'delete')){ ?>
                        <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Field of Stock?');" href="<?php echo site_url('stock_reg/stock/delete_field/{{row.id}}'); ?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        <?php //} ?>
                    </td>
                </tr>
            </table>
