            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">                                
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input name="room_no" class="form-control" >
                        </div>
                    </div>
...
<div class="container-fluid" >
    <div class="row" ng-controller="roomNoCtrl">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <!--<img class="img-responsive print-banner hide" src="<?php echo site_url('public/img/banner.jpg'); ?>"> -->
                ...
                <div ng-cloak class="row none" style="margin-bottom:15px;">
                 <div class="col-md-4">
                     <input type="text" ng-model="search" placeholder="Search by Room No..." class="form-control">
                </div>
            ...
            <table class="table table-bordered" ng-cloak>
                ...
                <tr dir-paginate="row in fields|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
                    ...
                    <td class="none text-center" >                        
                        ...
                        <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Room?');" href="<?php echo site_url('stock_reg/stock/delete_room/{{row.id}}'); ?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                        <?php //} ?>
                    </td>
                </tr>
            </table>
