                    ...
                    <div class="col-sm-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="num-center"> <?php echo $result->result_date; ?> </td>
                                ...
                                <td style="width: 50px;">
                                    <a class="btn btn-danger" onclick="return confirm('This file will delete permanently');" href="?id=<?php echo $result->id; ?> & img_url=<?php echo $result->result_attachment; ?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
