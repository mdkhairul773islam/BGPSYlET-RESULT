                    ...
                    <div class="col-sm-12">
                        ...
                        <?php foreach ($ad_info as $key => $calender) { ?>
                            <tr>
                                ...
                                <td class="num-center"> <?php echo $calender->ad_calender_date; ?> </td>
                                ...
                                <td style="width: 50px;">
                                    <a class="btn btn-danger" onclick="return confirm('This file will delete permanently');" href="?id=<?php echo $calender->id; ?>&img_url=<?php echo $calender->ad_calender_attachment; ?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
