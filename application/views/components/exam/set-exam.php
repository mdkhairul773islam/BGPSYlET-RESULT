    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">Starting Date <span class="req">*</span></label>
                    <div class="col-md-5">
                    ...
                    <script type="text/javascript">
                        $('#examStartAt').datetimepicker({format: 'YYYY-MM-DD LT'});
                    </script>
                </div>
            ...
            <div class="panel-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th class="num-center">Starting Date</th>
                        <th>Exam Name</th>
                        <th class="num-center">Exam Code</th>
                        <th>Action</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="num-center"><?php echo $row->start_at; ?></td>
                        <td><?php echo $row->name; ?></td>
                        <td class="num-center"><?php echo $row->code; ?></td>
                        <td width="110">
                            <a href="<?php echo site_url('exam/exam/editNewExam?id=' . $row->code); ?>" class="btn btn-warning">
