    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" name="exam_name" value="<?php echo $info[0]->title; ?>" class="form-control" readonly>
                </div>
            </div>
            ...
            <table class="table table-bordered exam">
                ...
                <tr>
                    ...
                    <td><input class="form-control" type="number" name="assignment_pm[]" ng-model="assignment_pm<?php echo $key; ?>" ng-init="assignment_pm<?php echo $key; ?>=<?php echo $row->assignment_pm; ?>" max="100" min="0"></td>
                    ...
                    <td><input class="form-control" type="number" name="cleanliness_pm[]" ng-model="cleanliness_pm<?php echo $key; ?>" ng-init="cleanliness_pm<?php echo $key; ?>=<?php echo $row->cleanliness_pm; ?>" max="100" min="0"></td>
