            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered exam">
                    <tr>
                        ...
                        <th ng-hide="row_active">Weekly Test</th>-->
                        <th>Written</th>
                        <th>Objective</th>
                    ...
                    <tr ng-repeat="mark in marks">
                        <td>
                            <input type="text" name="student_id" class="form-control" ng-model="mark.student_id" readonly>
                            <input type="hidden" name="roll" class="form-control" ng-value="mark.roll">
                            <input type="hidden" ng-value="id" name="id">
                            <input type="hidden" class="form-control" name="attendance" min="0" max="5" ng-model="mark.attendance" step="any">
                            <input type="hidden" class="form-control" name="monthlyTest" min="0" max="30" ng-model="mark.monthlyTest" step="any">
                        </td>
                        <td> 
                            <input type="text" name="subject" class="form-control" ng-model="mark.subject">
                        </td>
                        ...
                        <td>
                            <input
                                ...
                                min="0" max="{{ mark.assignment }}"
                                ng-model="mark.assignment" step="any">
                        </td>
                        
                        <td>
                            <input
                                type="number" class="form-control" name="cleanliness"
                                min="0" max="{{ mark.cleanliness }}"
                                ng-model="mark.cleanliness" step="any">
                        </td>
