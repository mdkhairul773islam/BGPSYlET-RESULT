                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="none" style="width: 216px;">
                                    <?php if(ck_action('registration_menu', 'view')){ ?>
                                    ...
                                    <?php if(ck_action('registration_menu', 'edit')){ ?>
                                    ...
                                    <?php if(ck_action('registration_menu', 'delete')){ ?>
                                    <a class="btn btn-danger" 
                                        onclick="return confirm('Are you sure to delete this Data');" 
                                        href="<?php echo base_url('admission/admission/allStudent?id='.$row->id); ?>">
                                        Delete
                                    </a>
                                    <?php } ?>
                                </td>
