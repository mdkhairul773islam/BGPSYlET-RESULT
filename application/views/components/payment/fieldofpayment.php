            ...
            <div class="panel-body no-padding">
                ...
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="field_name" class="form-control" autocomplete="off" >
                        </div>
                    </div>
...
<div class="container-fluid" >
    <div class="row" ng-controller="paymentFieldCtrl">
        <div class="panel panel-default">
            ...
            <table class="table table-bordered" ng-cloak>
                ...
                <tr dir-paginate="row in fields|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
                    ...
                    <td class="none text-center" >
                        <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Field of Payment?');" href="<?php echo site_url('payment/payment/delete_field/{{row.id}}'); ?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                    </td>
                </tr>
            </table>
