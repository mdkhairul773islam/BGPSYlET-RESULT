                ...
                ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="no-title">&nbsp;</div>
                            ...
                            <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input class="form-control" type="text" name="f_name" placeholder="Name">
                                        </div>
                                    </div>
				     ...
				     <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input type="text" name="mobile" class="form-control" placeholder="Type Your Name">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-md-3 control-label">ConfirmPassword</label>
                                        <div class="col-md-7">
                                            <input class="form-control" type="password" name="confirmPassword" placeholder="ConfirmPassword">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <select name="privilege" class="form-control">
                                                <option value="">-- Slecet Your Option --</option>
