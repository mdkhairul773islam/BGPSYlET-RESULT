            ...
            <div class="panel-body">
                <form action="#" method="POST">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="search[class]" class="form-control selectpicker" data-live-search="true">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="search[session]" class="form-control selectpicker" data-live-search="true">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <select name="search[section]" class="form-control selectpicker" data-live-search="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open_multipart('employee/attendance/importStudentData', ['class' => 'form-horizontal']); ?>
...
<script>
    ...
    function downloadFile (){
        window.location.href = "<?php echo site_url('private/student-attendance.csv');?>";
    }
</script>