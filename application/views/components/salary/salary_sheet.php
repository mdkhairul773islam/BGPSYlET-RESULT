    ...
    <div class="row">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <h4 class="text-center hide" style="margin:10px auto;">Salary Sheet</h4>
                    ...
                    <table class="table table-bordered" >
						...
						<?php 
						    ...
						    $basicInfo = $this->action->read("salary_structure",array("eid" => $value->employee_emp_id));
						    
						    $houe_rent = $this->action->read("incentive_structure",array("eid" => $value->employee_emp_id,"fields" => "HRA"));
						    $provident_fund_add = $this->action->read("incentive_structure",array("eid" => $value->employee_emp_id,"fields" => "Provident Fund"));
						    
						    $deductionInfo = $this->action->read("deduction_structure",array("eid" => $value->employee_emp_id,"fields" => "Provident Fund"));
                        ...
                        <tr>
                            ...
                            <td> <?php echo filter($value->employee_name); ?> </td>
                            <td> <?php echo $value->employee_emp_id; ?> </td>
                            <td> <?php echo filter($value->employee_designation); ?> </td>
