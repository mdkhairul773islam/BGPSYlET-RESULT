        ...
        <div class="panel panel-default">
            ...
            <div class="row">
                    ...
                    <div class="view-profile">
                        ...
                        <div class="col-xs-8">
                            <div class="institute">
                                <h2 class="text-center" style="margin-top: 10; font-weight: bold;">Border Guard Public School & COLLEGE</h2>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="none" style="width: 216px;">
                                    <a class="btn btn-info" href="<?php echo site_url('students/admission_view/student_profile')?>?id=<?php echo $students->id;?>"><i class="fa fa-eye"></i></a>
                                    <a class="btn btn-warning" href="<?php echo site_url('students/admission_view/student_edit')?>?id=<?php echo $students->id;?>"><i class="fa fa-pencil-square-o"></i></a>
                                    <a class="btn btn-danger" onclick="return confirm('Are you sure to delete this Data');" href="?delete_token=<?php echo $students->id;?>&img_url=<?php echo $students->photo;?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
