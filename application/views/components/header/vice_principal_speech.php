        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <!--blockquote class="form-head">
                    ...
                    <h4>Add Vice Principal Speech</h4>
                    ...
                    <div class="col-sm-12">
                        ...
                        echo form_open_multipart('', $attr);?>
                            ...
                            <div class="form-group clearfix">
                                <img class="pull-right" src="" id="p_image" alt="" class="img-thumbnail" style="height: 100px;" height="100px">
                            </div>
                            ...
                            <div class="btn-group pull-right">
                                <input type="submit" id="submit_btn" value="Save" name="add_speech" class="btn btn-primary">
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('header/speech/ajax_viceprincipal_speech'); ?>",
        }).success(function(response){
            if (response!="Error"){
                var data=JSON.parse(response);
                $("#p_image").attr("src","<?php echo base_url();?>"+data.vp_speech_path);
                $("#hidden_image_url").val(data.vp_speech_path);
                $("#hidden_id").val(data.id);
                tinyMCE.activeEditor.setContent(data.vp_speech_speech);
