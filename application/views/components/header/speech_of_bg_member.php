                ...
                <!-- horizontal form -->
                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                            ...
                            <input type="hidden" value="<?php echo custom_fetch($gb_speech_data,'speech_path'); ?>" id="hidden_image_url" name="hidden_image_url">
                            <input type="hidden" value="<?php echo custom_fetch($gb_speech_data,'id'); ?>" id="hidden_id" name="id_num">
                            
                            <div class="form-group clearfix">
                                <img class="pull-right" src="<?php echo base_url(custom_fetch($gb_speech_data,'speech_path')); ?>" id="p_image" class="img-thumbnail" style="height: 100px;" alt="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="tinyTextarea" class="form-control" cols="30" rows="15"  style="font-size: 15px;"><?php echo custom_fetch($gb_speech_data,'speech_speech') ?></textarea>
                            </div> 
                           <?php
                                $btn_info=array(
                                    'name'=>'add_speech',
