                    ...
                    <div class="col-sm-12">
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="tinyTextarea" class="form-control" cols="30" rows="15"  style="font-size: 15px;"><?php if($p_speech_data!=null){echo $p_speech_data[0]->speech_speech;} ?></textarea>
                            </div> 
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('header/speech/ajax_principal_speech'); ?>",
        }).success(function(response){
            if (response!="Error"){
                var data=JSON.parse(response);
                $("#p_image").attr("src","<?php echo base_url();?>"+data.speech_path);
                $("#hidden_image_url").val(data.speech_path);
