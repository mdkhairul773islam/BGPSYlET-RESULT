                        ...
                        echo form_open("",$attr);?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date col-md-5" id="datetimepickerFrom1">
                                    <input type="text" name="date[from]" required class="form-control" placeholder="YYYY-MM-DD">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date col-md-5" id="datetimepickerTo2">
                                    <input type="text" name="date[to]" required class="form-control" placeholder="YYYY-MM-DD">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
                        ...
                        <div class="view-profile">
                            ...
                            <div class="col-xs-2">
                                <figure class="pull-right">
                                    <img class="img-responsive" src="<?php echo base_url('public/students/'.$student[0]->photo);?>" style="width: 100px; height: 100px;" alt="Photo not found!" class="img-responsive">
                                </figure>
                            </div>
