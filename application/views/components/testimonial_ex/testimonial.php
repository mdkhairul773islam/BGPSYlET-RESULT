...
<div class="container-fluid">
    <div class="row" ng-controller="testimonialCtrl">
        <div class="panel panel-default">
            ...
            <div class="panel-body none">
                <form class="form-horizontal" ng-submit="getstudentinfoforTestimonialfn()">
                    <div class="form-group">
                        <label class="col-md-2 control-label">Year/Session</label>
                        <div class="col-md-5">
                            <select name="session" ng-model="search.session"  class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" name="reg_id" ng-model="search.reg_id" class="form-control" required>
                        </div>
                    </div>
