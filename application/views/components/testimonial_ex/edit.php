        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left"><?php echo caption('Edit'); ?></h1>                   
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-9">
                        <table class="student-table">
                            ...
                            <tr>
                                <th><?php echo caption('Fathers_Name'); ?></th>
                                <td><?php echo $testimonial[0]->father_name;?></td>
                            </tr>

                            <tr>
                                <th><?php echo caption('Mothers_Name'); ?></th>
                                <td><?php echo $testimonial[0]->mother_name;?></td>
                            </tr>

                            <tr>
                                <th><?php echo caption('Date_of_Birth'); ?></th>
                ...
                <?php echo form_open("testimonial/update/".$testimonial[0]->student_id,$attr);?>              
                   <div class="form-group">
                        <label class="control-label"><?php echo caption('Roll'); ?></label>
                    ...
                    <div class="form-group">
                        <label class="control-label"><?php echo caption('GPA'); ?></label>
                        <div class="custom-file">
                    ...
                    <div class="btn-group pull-right">
                        <input type="submit" name="submit" value="<?php echo caption('Update'); ?>" class="btn btn-primary">
                    </div>                    
                <?php echo form_close();?>
             </div>
