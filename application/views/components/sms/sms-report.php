    ...
    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date col-md-9" id="datetimepickerSMSFrom">
                                    <input type="text" name="date_from" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="YYYY-MM-DD">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date col-md-9" id="datetimepickerSMSTo">
                                    <input type="text" name="date_to" class="form-control" value="<?php echo date('Y-m-d'); ?>" placeholder="YYYY-MM-DD">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-calendar"></span>
                                    </span>
                                </div>
		...
		<?php foreach($sms_record as $key=>$all_sms){?>
                    <tr>
                        ...
                        <td class="num-center"><?php echo $all_sms->delivery_date; ?></td>
                        <td class="num-center"><?php echo $all_sms->mobile; ?></td>
