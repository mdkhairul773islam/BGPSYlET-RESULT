            ...
            <div class="panel-body">
                ...
                ?>
                    <ol style="font-size: 14px;">
                        ...
                        <li>Total SMS : <strong><?php echo $total_sms = config_item('total_sms'); ?></strong>, &nbsp; Total Sent SMS : <strong><?php echo $sent_sms; ?></strong>, &nbsp; Remaining SMS : <strong><?php echo $total_sms-$sent_sms; ?></strong></li>
                    </ol>
