...
<head>
    <?php
        ...
        $site_name = json_decode($theme_data[0]->contact_info,true);
    ?>
    <title><?php echo $site_name['site_name']; ?> | <?php echo ucwords(str_replace('_',' ',$meta_title));?></title>

    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1" />

    <link rel="icon" type="image/png" href="<?php echo site_url($favicon['icon']);?>">
    <!-- include css -->
